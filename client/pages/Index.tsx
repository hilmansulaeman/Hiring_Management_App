                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-start">
                      ...
                      <Link
                        ...
                        className="inline-flex items-center justify-center px-4 py-2 text-sm font-bold text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                      >
                        Apply
                      </Link>
                    </div>
